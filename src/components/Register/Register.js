...
import authRegisterValidationActions from "../../actions/authRegisterValidationActions";
import {REGISTER_INPUT_VALIDATED, REGISTER_VALIDATION_ERROR} from "../../constants";
...
const Register = () => {
    ...
    return (
        <div className="row d-flex justify-content-center background-container">
            <div style={{marginTop:"0px"}} className="col-md-3 align-self-center  login-form fadeInDown">
